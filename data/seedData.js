...
const patientDefinitions = [
  ...
  // ── ICU-1 additional patients (rooms 113A–162B) ───────────────────────────
  { name: 'Alfred Beaumont',      dob: '1953-04-07', room: '113A', unit: 'ICU-1', diagnosis: 'Acute decompensated heart failure, IV diuresis',    acuityLevel: 'critical' },
  { name: 'Constance Aldridge',   dob: '1947-09-21', room: '113B', unit: 'ICU-1', diagnosis: 'Cardiogenic pulmonary oedema, BiPAP',                acuityLevel: 'critical' },
  { name: 'Reginald Baines',      dob: '1961-02-14', room: '114A', unit: 'ICU-1', diagnosis: 'Third-degree heart block, transcutaneous pacing',    acuityLevel: 'critical' },
  { name: 'Millicent Braxton',    dob: '1955-07-30', room: '114B', unit: 'ICU-1', diagnosis: 'Hypertrophic cardiomyopathy, LVOT obstruction',      acuityLevel: 'high'     },
  { name: 'Cornelius Ashby',      dob: '1970-11-18', room: '115A', unit: 'ICU-1', diagnosis: 'Pericardial tamponade, pericardiocentesis done',     acuityLevel: 'critical' },
  { name: 'Sylvester Crane',      dob: '1963-05-03', room: '115B', unit: 'ICU-1', diagnosis: 'Acute limb ischaemia, vascular surgery review',      acuityLevel: 'high'     },
  { name: 'Arabella Doyle',       dob: '1949-08-27', room: '116A', unit: 'ICU-1', diagnosis: 'NSTEMI, cardiac catheterisation pending',            acuityLevel: 'high'     },
  { name: 'Edmund Fitch',         dob: '1975-01-09', room: '116B', unit: 'ICU-1', diagnosis: 'Ventricular tachycardia storm, amiodarone drip',     acuityLevel: 'critical' },
  { name: 'Beatrix Galloway',     dob: '1958-06-14', room: '117A', unit: 'ICU-1', diagnosis: 'Mitral valve regurgitation, decompensated',          acuityLevel: 'high'     },
  { name: 'Horace Greenfield',    dob: '1943-12-01', room: '117B', unit: 'ICU-1', diagnosis: 'Aortic stenosis, TAVR candidacy evaluation',         acuityLevel: 'medium'   },
  { name: 'Isadora Hawthorne',    dob: '1967-03-22', room: '118A', unit: 'ICU-1', diagnosis: 'Infective endocarditis, strep viridans bacteraemia',  acuityLevel: 'critical' },
  { name: 'Jasper Ingram',        dob: '1952-10-08', room: '118B', unit: 'ICU-1', diagnosis: 'Post-coronary artery bypass, sternal wound infection', acuityLevel: 'high'    },
  { name: 'Lavinia Jennings',     dob: '1980-07-17', room: '119A', unit: 'ICU-1', diagnosis: 'Stress cardiomyopathy (Takotsubo syndrome)',          acuityLevel: 'high'     },
  { name: 'Montgomery Knox',      dob: '1946-04-29', room: '119B', unit: 'ICU-1', diagnosis: 'Peripheral arterial disease, below-knee amputation',  acuityLevel: 'medium'   },
  { name: 'Norah Langley',        dob: '1972-09-05', room: '120A', unit: 'ICU-1', diagnosis: 'Hypovolaemic shock, massive GI haemorrhage',          acuityLevel: 'critical' },
  { name: 'Oswald Lennox',        dob: '1960-02-20', room: '120B', unit: 'ICU-1', diagnosis: 'Post-STEMI heart failure, IABP support',             acuityLevel: 'critical' },
  { name: 'Patience Marlowe',     dob: '1985-11-13', room: '121A', unit: 'ICU-1', diagnosis: 'Severe aortic regurgitation, haemodynamic compromise', acuityLevel: 'critical' },
  { name: 'Quincy Norwood',       dob: '1957-06-08', room: '121B', unit: 'ICU-1', diagnosis: 'Post-ablation flutter, monitoring',                  acuityLevel: 'medium'   },
  { name: 'Rosamund Oakes',       dob: '1941-01-31', room: '122A', unit: 'ICU-1', diagnosis: 'Ruptured papillary muscle post-MI, cardiogenic shock', acuityLevel: 'critical' },
  { name: 'Seymour Parrish',      dob: '1968-08-16', room: '122B', unit: 'ICU-1', diagnosis: 'SVT refractory to adenosine, EP consult',            acuityLevel: 'high'     },
  { name: 'Tabitha Quinlan',      dob: '1977-03-04', room: '123A', unit: 'ICU-1', diagnosis: 'Septic cardiomyopathy, dobutamine support',           acuityLevel: 'critical' },
  { name: 'Ulysses Ramsey',       dob: '1950-10-27', room: '123B', unit: 'ICU-1', diagnosis: 'Wolff-Parkinson-White, pre-excitation arrhythmia',    acuityLevel: 'medium'   },
  { name: 'Vivienne Stanton',     dob: '1964-05-19', room: '124A', unit: 'ICU-1', diagnosis: 'Post-cardiac arrest day 3, targeted temperature management', acuityLevel: 'critical' },
  { name: 'Wilbur Thorne',        dob: '1956-12-07', room: '124B', unit: 'ICU-1', diagnosis: 'Severe AS with syncope, urgent valve replacement',   acuityLevel: 'critical' },
  { name: 'Xenia Underwood',      dob: '1983-07-22', room: '125A', unit: 'ICU-1', diagnosis: 'Long QT syndrome, torsades de pointes',              acuityLevel: 'critical' },

  // ── ICU-2 additional patients (rooms 213A–237B) ───────────────────────────
  { name: 'Yvette Ainsworth',     dob: '1966-02-11', room: '213A', unit: 'ICU-2', diagnosis: 'Hypercapnic respiratory failure, CPAP titration',    acuityLevel: 'high'     },
  { name: 'Zacharias Barton',     dob: '1951-09-04', room: '213B', unit: 'ICU-2', diagnosis: 'Bilateral pneumonia, high-flow oxygen therapy',       acuityLevel: 'critical' },
  { name: 'Adelaide Cassidy',     dob: '1973-06-28', room: '214A', unit: 'ICU-2', diagnosis: 'Interstitial lung disease, acute exacerbation',       acuityLevel: 'critical' },
  { name: 'Benedict Dalton',      dob: '1959-11-15', room: '214B', unit: 'ICU-2', diagnosis: 'Massive haemothorax, chest tube output high',         acuityLevel: 'critical' },
  { name: 'Camilla Edmonds',      dob: '1979-04-03', room: '215A', unit: 'ICU-2', diagnosis: 'Severe obstructive sleep apnoea, BiPAP initiation',   acuityLevel: 'medium'   },
  { name: 'Dashiell Farrow',      dob: '1944-07-19', room: '215B', unit: 'ICU-2', diagnosis: 'Post-pneumonectomy day 4, air leak management',       acuityLevel: 'high'     },
  { name: 'Eloise Grantham',      dob: '1969-01-07', room: '216A', unit: 'ICU-2', diagnosis: 'Lung abscess, bronchoscopic drainage pending',        acuityLevel: 'high'     },
  { name: 'Fabian Hollister',     dob: '1957-08-25', room: '216B', unit: 'ICU-2', diagnosis: 'Pulmonary sarcoidosis, steroid therapy initiated',    acuityLevel: 'medium'   },
  { name: 'Georgiana Irvine',     dob: '1982-03-12', room: '217A', unit: 'ICU-2', diagnosis: 'Spontaneous pneumothorax, pleurodesis planned',       acuityLevel: 'high'     },
  { name: 'Hartwell Jenner',      dob: '1948-10-30', room: '217B', unit: 'ICU-2', diagnosis: 'Chronic obstructive pulmonary disease, NIV dependent', acuityLevel: 'high'    },
  { name: 'Imogen Kirby',         dob: '1975-05-16', room: '218A', unit: 'ICU-2', diagnosis: 'Tracheal stenosis, urgent bronchoscopy',              acuityLevel: 'critical' },
  { name: 'Julian Lancaster',     dob: '1963-12-03', room: '218B', unit: 'ICU-2', diagnosis: 'Bronchopleural fistula, surgical consult',            acuityLevel: 'critical' },
  { name: 'Katarina Mercer',      dob: '1990-07-21', room: '219A', unit: 'ICU-2', diagnosis: 'Allergic bronchopulmonary aspergillosis, voriconazole', acuityLevel: 'medium' },
  { name: 'Leopold Norris',       dob: '1954-02-09', room: '219B', unit: 'ICU-2', diagnosis: 'Post-CABG respiratory failure, vent weaning',         acuityLevel: 'critical' },
  { name: 'Marcella Ogilvie',     dob: '1971-09-28', room: '220A', unit: 'ICU-2', diagnosis: 'Lymphangioleiomyomatosis, oxygen-dependent',           acuityLevel: 'high'     },
  { name: 'Nigel Pemberton',      dob: '1945-04-14', room: '220B', unit: 'ICU-2', diagnosis: 'Post-lung biopsy pneumothorax, observation',          acuityLevel: 'medium'   },
  { name: 'Ophelia Quentin',      dob: '1978-11-01', room: '221A', unit: 'ICU-2', diagnosis: 'Respiratory syncytial virus pneumonia, immune-compromised', acuityLevel: 'critical' },
  { name: 'Pascal Redmond',       dob: '1961-06-17', room: '221B', unit: 'ICU-2', diagnosis: 'Empyema necessitans, VATS drainage',                  acuityLevel: 'critical' },
  { name: 'Quintessa Shelby',     dob: '1987-01-24', room: '222A', unit: 'ICU-2', diagnosis: 'Endobronchial tumour, haemoptysis control',           acuityLevel: 'critical' },
  { name: 'Roderick Talbot',      dob: '1952-08-11', room: '222B', unit: 'ICU-2', diagnosis: 'Cystic fibrosis exacerbation, IV tobramycin',         acuityLevel: 'high'     },
  { name: 'Selena Underhill',     dob: '1976-03-29', room: '223A', unit: 'ICU-2', diagnosis: 'Bronchiectasis, haemoptysis, embolisation planned',   acuityLevel: 'high'     },
  { name: 'Theron Vance',         dob: '1947-10-06', room: '223B', unit: 'ICU-2', diagnosis: 'Wegener granulomatosis, pulmonary haemorrhage',        acuityLevel: 'critical' },
  { name: 'Ursula Whitmore',      dob: '1984-05-23', room: '224A', unit: 'ICU-2', diagnosis: 'Post-transplant obliterative bronchiolitis',           acuityLevel: 'high'     },
  { name: 'Vance Yarborough',     dob: '1955-12-10', room: '224B', unit: 'ICU-2', diagnosis: 'Aspiration pneumonia, dysphagia workup',              acuityLevel: 'high'     },
  { name: 'Wilhelmina Zane',      dob: '1969-07-07', room: '225A', unit: 'ICU-2', diagnosis: 'Tracheobronchitis, immunosuppressed host',             acuityLevel: 'medium'   },

  // ── MedSurg-3 additional patients (rooms 371–520) ─────────────────────────
  { name: 'Xavier Abbott',        dob: '1978-04-18', room: '371',  unit: 'MedSurg-3', diagnosis: 'Post-op total knee replacement day 3',             acuityLevel: 'low'    },
  { name: 'Yolanda Acosta',       dob: '1955-09-02', room: '372',  unit: 'MedSurg-3', diagnosis: 'Cellulitis lower leg, IV cefazolin',               acuityLevel: 'medium' },
  { name: 'Zebediah Aldrich',     dob: '1962-01-25', room: '373',  unit: 'MedSurg-3', diagnosis: 'Constipation, small bowel obstruction rule-out',   acuityLevel: 'low'    },
  { name: 'Abigail Baxter',       dob: '1990-06-11', room: '374',  unit: 'MedSurg-3', diagnosis: 'Acute pyelonephritis, IV gentamicin',              acuityLevel: 'medium' },
  { name: 'Aldous Bentley',       dob: '1947-11-30', room: '375',  unit: 'MedSurg-3', diagnosis: 'Delirium secondary to UTI, elderly',               acuityLevel: 'medium' },
  { name: 'Bernadette Boyle',     dob: '1974-03-14', room: '376',  unit: 'MedSurg-3', diagnosis: 'Ischaemic colitis, conservative management',        acuityLevel: 'medium' },
  { name: 'Calvin Briggs',        dob: '1981-08-07', room: '377',  unit: 'MedSurg-3', diagnosis: 'Post-op laparoscopic appendectomy day 1',          acuityLevel: 'low'    },
  { name: 'Delilah Cannon',       dob: '1959-12-22', room: '378',  unit: 'MedSurg-3', diagnosis: 'Diverticular abscess, CT-guided drainage',         acuityLevel: 'medium' },
  { name: 'Elliott Chandler',     dob: '1945-05-08', room: '379',  unit: 'MedSurg-3', diagnosis: 'Hip fracture, pain management, awaiting surgery',  acuityLevel: 'high'   },
  { name: 'Fiona Clifford',       dob: '1983-10-19', room: '380',  unit: 'MedSurg-3', diagnosis: 'Hyperemesis gravidarum, IV antiemetics',            acuityLevel: 'low'    },
  { name: 'Griffith Colby',       dob: '1952-07-04', room: '381',  unit: 'MedSurg-3', diagnosis: 'Acute cholecystitis, cholecystectomy planned',      acuityLevel: 'medium' },
  { name: 'Helena Compton',       dob: '1976-02-17', room: '382',  unit: 'MedSurg-3', diagnosis: 'Migraine with status migrainosus, IV DHE',         acuityLevel: 'medium' },
  { name: 'Irving Conway',        dob: '1941-09-05', room: '383',  unit: 'MedSurg-3', diagnosis: 'Failure to thrive, elderly, nutrition support',    acuityLevel: 'medium' },
  { name: 'Jocelyn Craig',        dob: '1968-04-28', room: '384',  unit: 'MedSurg-3', diagnosis: 'Syncope workup, cardiology monitoring',             acuityLevel: 'medium' },
  { name: 'Knox Dalton',          dob: '1985-11-12', room: '385',  unit: 'MedSurg-3', diagnosis: 'Osteomyelitis, IV antibiotics course',              acuityLevel: 'medium' },
  { name: 'Lydia Davenport',      dob: '1957-06-24', room: '386',  unit: 'MedSurg-3', diagnosis: 'Peptic ulcer disease, H. pylori eradication',      acuityLevel: 'low'    },
  { name: 'Magnus Drummond',      dob: '1979-01-16', room: '387',  unit: 'MedSurg-3', diagnosis: 'Chronic kidney disease stage 4, fluid management', acuityLevel: 'medium' },
  { name: 'Nadia Eaton',          dob: '1964-08-31', room: '388',  unit: 'MedSurg-3', diagnosis: 'Ulcerative colitis flare, IV steroids',             acuityLevel: 'medium' },
  { name: 'Obadiah Fenwick',      dob: '1950-03-07', room: '389',  unit: 'MedSurg-3', diagnosis: 'Hepatic encephalopathy, lactulose therapy',         acuityLevel: 'high'   },
  { name: 'Priscilla Garrett',    dob: '1987-10-20', room: '390',  unit: 'MedSurg-3', diagnosis: 'Post-op thyroid lobectomy, calcium monitoring',     acuityLevel: 'low'    },
  { name: 'Quinton Hale',         dob: '1943-05-15', room: '391',  unit: 'MedSurg-3', diagnosis: 'Subdural haematoma, neurology observation',         acuityLevel: 'high'   },
  { name: 'Rosalind Ingram',      dob: '1972-12-03', room: '392',  unit: 'MedSurg-3', diagnosis: 'Adrenal insufficiency, IV hydrocortisone',          acuityLevel: 'medium' },
  { name: 'Sinclair Jennings',    dob: '1966-07-19', room: '393',  unit: 'MedSurg-3', diagnosis: 'Post-op ORIF femur, DVT prophylaxis',              acuityLevel: 'medium' },
  { name: 'Theodora Keane',       dob: '1953-02-08', room: '394',  unit: 'MedSurg-3', diagnosis: 'Anaemia of chronic disease, iron infusion',         acuityLevel: 'low'    },
  { name: 'Ulrich Lambert',       dob: '1980-09-26', room: '395',  unit: 'MedSurg-3', diagnosis: 'Renal colic, stent insertion planned',              acuityLevel: 'medium' },
  { name: 'Valentina Marsh',      dob: '1948-04-11', room: '396',  unit: 'MedSurg-3', diagnosis: 'Hyperosmolar non-ketotic coma, IV insulin',         acuityLevel: 'high'   },
  { name: 'Winston Neville',      dob: '1975-11-07', room: '397',  unit: 'MedSurg-3', diagnosis: 'Post-op Whipple procedure, post-op day 5',         acuityLevel: 'medium' },
  { name: 'Xander Ogden',         dob: '1961-06-22', room: '398',  unit: 'MedSurg-3', diagnosis: 'Hepatitis B flare, antivirals initiated',           acuityLevel: 'medium' },
  { name: 'Yvonne Paige',         dob: '1984-01-14', room: '399',  unit: 'MedSurg-3', diagnosis: 'Sickle cell crisis, IV morphine protocol',          acuityLevel: 'high'   },
  { name: 'Zara Prescott',        dob: '1946-08-29', room: '400',  unit: 'MedSurg-3', diagnosis: 'Post-fall hip contusion, elderly, PT consult',      acuityLevel: 'low'    },
  { name: 'Aaron Quincy',         dob: '1977-03-17', room: '401',  unit: 'MedSurg-3', diagnosis: 'Inflammatory bowel disease, elemental diet',        acuityLevel: 'medium' },
  { name: 'Beatrix Raymond',      dob: '1963-10-05', room: '402',  unit: 'MedSurg-3', diagnosis: 'Post-op bladder resection, urology follow-up',      acuityLevel: 'medium' },
  { name: 'Chester Stafford',     dob: '1949-05-21', room: '403',  unit: 'MedSurg-3', diagnosis: 'Prostatitis, IV antibiotics',                       acuityLevel: 'low'    },
  { name: 'Daphne Thornton',      dob: '1986-12-09', room: '404',  unit: 'MedSurg-3', diagnosis: 'Endometriosis, post-laparoscopic surgery',          acuityLevel: 'low'    },
  { name: 'Edgar Upton',          dob: '1958-07-16', room: '405',  unit: 'MedSurg-3', diagnosis: 'Rheumatoid arthritis flare, IV methylprednisolone', acuityLevel: 'medium' },
  { name: 'Felicity Vane',        dob: '1971-02-04', room: '406',  unit: 'MedSurg-3', diagnosis: 'Postoperative ileus, NG decompression',             acuityLevel: 'medium' },
  { name: 'Gerald Walcott',       dob: '1944-09-18', room: '407',  unit: 'MedSurg-3', diagnosis: 'Chronic liver disease, variceal band ligation',     acuityLevel: 'high'   },
  { name: 'Harriet Weston',       dob: '1982-04-06', room: '408',  unit: 'MedSurg-3', diagnosis: 'Systemic lupus erythematosus flare, renal involvement', acuityLevel: 'high' },
  { name: 'Isaiah Whitfield',     dob: '1956-11-23', room: '409',  unit: 'MedSurg-3', diagnosis: 'Post-amputation stump care, prosthetics referral',  acuityLevel: 'medium' },
  { name: 'Josephine York',       dob: '1979-06-10', room: '410',  unit: 'MedSurg-3', diagnosis: 'Acute angle-closure glaucoma, IV acetazolamide',    acuityLevel: 'medium' },
  { name: 'Kieran Ashford',       dob: '1967-01-27', room: '411',  unit: 'MedSurg-3', diagnosis: 'Transient ischaemic attack, antiplatelet therapy',  acuityLevel: 'medium' },
  { name: 'Loretta Baines',       dob: '1991-08-14', room: '412',  unit: 'MedSurg-3', diagnosis: 'Ovarian torsion, post-laparoscopic day 1',          acuityLevel: 'low'    },
  { name: 'Marcus Bentham',       dob: '1954-03-30', room: '413',  unit: 'MedSurg-3', diagnosis: 'Psoriatic arthropathy flare, biologics review',     acuityLevel: 'low'    },
  { name: 'Natasha Blaine',       dob: '1981-10-17', room: '414',  unit: 'MedSurg-3', diagnosis: 'Post-op cholecystectomy, bile duct injury query',   acuityLevel: 'medium' },
  { name: 'Orlando Briggs',       dob: '1946-05-04', room: '415',  unit: 'MedSurg-3', diagnosis: 'Vertebral fracture, pain management, TLSO brace',   acuityLevel: 'medium' },
  { name: 'Penelope Caldwell',    dob: '1969-12-21', room: '416',  unit: 'MedSurg-3', diagnosis: 'Diverticulitis with pericolic fat stranding',        acuityLevel: 'medium' },
  { name: 'Ralph Carrington',     dob: '1983-07-08', room: '417',  unit: 'MedSurg-3', diagnosis: 'Testicular torsion, post-orchidopexy day 2',        acuityLevel: 'low'    },
  { name: 'Sabrina Dalton',       dob: '1960-02-15', room: '418',  unit: 'MedSurg-3', diagnosis: 'Aortic aneurysm surveillance, scheduled imaging',   acuityLevel: 'low'    },
  { name: 'Tristan Emery',        dob: '1977-09-02', room: '419',  unit: 'MedSurg-3', diagnosis: 'Ruptured Baker cyst, orthopaedics consult',         acuityLevel: 'low'    },
  { name: 'Una Fitzgerald',       dob: '1952-04-19', room: '420',  unit: 'MedSurg-3', diagnosis: 'Polymyalgia rheumatica, steroid taper',              acuityLevel: 'low'    },
  { name: 'Victor Gallagher',     dob: '1940-11-06', room: '421',  unit: 'MedSurg-3', diagnosis: 'Spinal stenosis, epidural steroid injection',        acuityLevel: 'low'    },
  { name: 'Willa Harrington',     dob: '1974-06-23', room: '422',  unit: 'MedSurg-3', diagnosis: 'Ectopic pregnancy ruptured, post-salpingectomy',    acuityLevel: 'medium' },
  { name: 'Xyla Ingram',          dob: '1988-01-10', room: '423',  unit: 'MedSurg-3', diagnosis: 'Anorexia nervosa, NG refeeding protocol',           acuityLevel: 'high'   },
  { name: 'Yorick James',         dob: '1965-08-27', room: '424',  unit: 'MedSurg-3', diagnosis: 'Necrotising fasciitis, post-debridement wound care', acuityLevel: 'high'   },
  { name: 'Zelda Kirk',           dob: '1958-03-13', room: '425',  unit: 'MedSurg-3', diagnosis: 'Hepatorenal syndrome, nephrology co-management',    acuityLevel: 'high'   },
  { name: 'Ambrose Lawton',       dob: '1970-10-01', room: '426',  unit: 'MedSurg-3', diagnosis: 'Post-op prostatectomy, urinary catheter care',      acuityLevel: 'low'    },
  { name: 'Blythe Manning',       dob: '1985-05-18', room: '427',  unit: 'MedSurg-3', diagnosis: 'Toxic shock syndrome, IV clindamycin & fluids',     acuityLevel: 'high'   },
  { name: 'Cormac Napier',        dob: '1943-12-25', room: '428',  unit: 'MedSurg-3', diagnosis: 'Parkinson disease, aspiration risk, speech therapy', acuityLevel: 'medium' },
  { name: 'Dorothea Ogilvie',     dob: '1971-07-12', room: '429',  unit: 'MedSurg-3', diagnosis: 'Post-op ovarian cystectomy, observation',           acuityLevel: 'low'    },
  { name: 'Everett Paxton',       dob: '1962-02-28', room: '430',  unit: 'MedSurg-3', diagnosis: 'Haemophilia A, joint bleed, factor VIII infusion',  acuityLevel: 'medium' },
  { name: 'Francesca Quincy',     dob: '1979-09-14', room: '431',  unit: 'MedSurg-3', diagnosis: 'Hypothyroidism crisis, IV levothyroxine',           acuityLevel: 'high'   },
  { name: 'Graham Redwood',       dob: '1948-04-01', room: '432',  unit: 'MedSurg-3', diagnosis: 'Post-op ileostomy reversal, diet advancement',      acuityLevel: 'medium' },
  { name: 'Hester Sanderson',     dob: '1966-11-17', room: '433',  unit: 'MedSurg-3', diagnosis: 'Medullary thyroid cancer, post-total thyroidectomy', acuityLevel: 'medium' },
  { name: 'Ivan Thornton',        dob: '1984-06-04', room: '434',  unit: 'MedSurg-3', diagnosis: 'Testicular cancer, post-orchiectomy day 2',         acuityLevel: 'low'    },
  { name: 'Jacinda Upton',        dob: '1957-01-21', room: '435',  unit: 'MedSurg-3', diagnosis: 'Systemic sclerosis, pulmonary hypertension review',  acuityLevel: 'medium' },
  { name: 'Kent Vickers',         dob: '1981-08-08', room: '436',  unit: 'MedSurg-3', diagnosis: 'Alcohol hepatitis, steroid therapy',                 acuityLevel: 'high'   },
  { name: 'Lynnea Walton',        dob: '1953-03-25', room: '437',  unit: 'MedSurg-3', diagnosis: 'Rectal prolapse, post-surgical repair',              acuityLevel: 'medium' },
  { name: 'Milo Yeoman',          dob: '1977-10-12', room: '438',  unit: 'MedSurg-3', diagnosis: 'Temporal arteritis, high-dose prednisolone',         acuityLevel: 'medium' },
  { name: 'Neva Ziegler',         dob: '1946-05-29', room: '439',  unit: 'MedSurg-3', diagnosis: 'Dementia with behavioural disturbance, review',      acuityLevel: 'medium' },
  { name: 'Oliver Ashton',        dob: '1968-12-16', room: '440',  unit: 'MedSurg-3', diagnosis: 'Peripheral neuropathy, IV immunoglobulin',           acuityLevel: 'medium' },
  { name: 'Petra Blackmore',      dob: '1975-07-03', room: '441',  unit: 'MedSurg-3', diagnosis: 'Post-op mastectomy, drain site monitoring',          acuityLevel: 'low'    },
  { name: 'Rex Calloway',         dob: '1960-02-20', room: '442',  unit: 'MedSurg-3', diagnosis: 'Chronic pancreatitis, pain management plan',         acuityLevel: 'medium' },
  { name: 'Sienna Doyle',         dob: '1988-09-07', room: '443',  unit: 'MedSurg-3', diagnosis: 'Gestational diabetes, insulin optimisation',         acuityLevel: 'low'    },
  { name: 'Talbot Emerson',       dob: '1945-04-14', room: '444',  unit: 'MedSurg-3', diagnosis: 'Chronic venous ulcer, compression dressing',         acuityLevel: 'low'    },
  { name: 'Uma Forsythe',         dob: '1982-11-01', room: '445',  unit: 'MedSurg-3', diagnosis: 'Pre-eclampsia, BP monitoring, OB-GYN review',        acuityLevel: 'high'   },
  { name: 'Vernon Gillespie',     dob: '1956-06-18', room: '446',  unit: 'MedSurg-3', diagnosis: 'Post-op sigmoid colectomy, stoma management',        acuityLevel: 'medium' },
  { name: 'Wendy Holloway',       dob: '1970-01-05', room: '447',  unit: 'MedSurg-3', diagnosis: 'Multiple sclerosis relapse, IV methylprednisolone',  acuityLevel: 'medium' },
  { name: 'Ximena Ingleton',      dob: '1964-08-22', room: '448',  unit: 'MedSurg-3', diagnosis: 'Myeloma, hypercalcaemia, IV zoledronic acid',        acuityLevel: 'medium' },
  { name: 'Yale Jenner',          dob: '1949-03-09', room: '449',  unit: 'MedSurg-3', diagnosis: 'Fall with subdural hygroma, neurosurgery review',    acuityLevel: 'high'   },
  { name: 'Zoe Kingston',         dob: '1986-10-26', room: '450',  unit: 'MedSurg-3', diagnosis: 'Post-op Achilles tendon repair, non-weight-bearing', acuityLevel: 'low'    },
  { name: 'Adrian Lockwood',      dob: '1958-05-13', room: '451',  unit: 'MedSurg-3', diagnosis: 'Recurrent UTI, urology imaging',                    acuityLevel: 'low'    },
  { name: 'Bianca Malone',        dob: '1976-12-30', room: '452',  unit: 'MedSurg-3', diagnosis: 'Post-op hysterectomy, haemoglobin monitoring',       acuityLevel: 'medium' },
  { name: 'Clifton Nash',         dob: '1943-07-17', room: '453',  unit: 'MedSurg-3', diagnosis: 'Aspiration pneumonia, speech therapy, PEG query',    acuityLevel: 'high'   },
  { name: 'Dahlia Orton',         dob: '1980-02-04', room: '454',  unit: 'MedSurg-3', diagnosis: 'Irritable bowel syndrome, symptom management',       acuityLevel: 'low'    },
  { name: 'Ernest Pendleton',     dob: '1967-09-21', room: '455',  unit: 'MedSurg-3', diagnosis: 'Post-op bowel perforation repair, drain in situ',    acuityLevel: 'medium' },
  { name: 'Fiora Quinlan',        dob: '1955-04-08', room: '456',  unit: 'MedSurg-3', diagnosis: 'Hyperaldosteronism, potassium replacement',          acuityLevel: 'medium' },
  { name: 'Graydon Russell',      dob: '1989-11-15', room: '457',  unit: 'MedSurg-3', diagnosis: 'Appendiceal abscess, IV antibiotics, interval appendicectomy', acuityLevel: 'medium' },
  { name: 'Helena Shelton',       dob: '1948-06-02', room: '458',  unit: 'MedSurg-3', diagnosis: 'Post-fall wrist fracture, ORIF, orthopaedic obs',    acuityLevel: 'low'    },
  { name: 'Ignatius Tanner',      dob: '1974-01-19', room: '459',  unit: 'MedSurg-3', diagnosis: 'Crohn disease fistula, surgical review',             acuityLevel: 'medium' },
  { name: 'Jovita Underwood',     dob: '1961-08-06', room: '460',  unit: 'MedSurg-3', diagnosis: 'Renal transplant rejection workup, tacrolimus adj.',  acuityLevel: 'high'   },
  { name: 'Kelvin Voss',          dob: '1979-03-23', room: '461',  unit: 'MedSurg-3', diagnosis: 'Hepatic abscess, percutaneous drainage',             acuityLevel: 'medium' },
  { name: 'Lorelei Watts',        dob: '1953-10-10', room: '462',  unit: 'MedSurg-3', diagnosis: 'Mitral valve prolapse, palpitation monitoring',       acuityLevel: 'low'    },
  { name: 'Malcolm Yarrow',       dob: '1970-05-27', room: '463',  unit: 'MedSurg-3', diagnosis: 'Post-op Hartmann reversal, wound inspection',        acuityLevel: 'medium' },
  { name: 'Nina Zorn',            dob: '1987-12-14', room: '464',  unit: 'MedSurg-3', diagnosis: 'Pelvic inflammatory disease, IV antibiotics',        acuityLevel: 'medium' },
  { name: 'Otto Alderton',        dob: '1944-07-01', room: '465',  unit: 'MedSurg-3', diagnosis: 'Iatrogenic drug rash, dermatology review',           acuityLevel: 'low'    },
  { name: 'Portia Bevan',         dob: '1982-02-18', room: '466',  unit: 'MedSurg-3', diagnosis: 'Thyroid nodule biopsy, observation',                 acuityLevel: 'low'    },
  { name: 'Quinn Caldwell',       dob: '1963-09-05', room: '467',  unit: 'MedSurg-3', diagnosis: 'Atrial flutter, cardioversion planned',              acuityLevel: 'medium' },
  { name: 'Roselyn Drake',        dob: '1956-04-22', room: '468',  unit: 'MedSurg-3', diagnosis: 'Pleural effusion, thoracocentesis, MedSurg step-down', acuityLevel: 'medium' },
  { name: 'Stafford Elliott',     dob: '1985-11-09', room: '469',  unit: 'MedSurg-3', diagnosis: 'Soft tissue sarcoma, post-excision wound care',      acuityLevel: 'medium' },
  { name: 'Tamsin Farrow',        dob: '1947-06-16', room: '470',  unit: 'MedSurg-3', diagnosis: 'Post-op femoral artery bypass, vascular obs',        acuityLevel: 'medium' },
];
